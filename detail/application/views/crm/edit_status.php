...
<input type="hidden" placeholder="Enter cc Name" required
        ...
        <table class="table gridexample">
          <tr>
            <td>status</td>
            <td>
        <input type="text" autofocus value="<?php echo $result1->status_name;?>" placeholder="Enter status name" required id="country" class="form-control txt" name="country" tabindex="1"></td>
             </tr>
          <tr>
...
$done=$this->db->query("update grc_status_tbl set status name='$statusname' 
