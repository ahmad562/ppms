<div class="pcoded-content">
   ...
   <td><a href="<?php echo base_url()?>Welcome/edit_tier/<?php echo $item->tier_id;?>">
...
<input type="hidden" placeholder="Enter tier Name" required
        ...
        <table class="table gridexample">
          <tr>
            <td>Tier</td>
            <td>
        <input type="text" autofocus value="<?php echo $result1->tier_name;?>" placeholder="Enter tier Name" required id="tier" class="form-control txt" name="tier" tabindex="1"></td>
             </tr>
          <tr>
...
$done=$this->db->query("update grm_tier_tbl set tier_name='$tier' 
where tier_id=$tier_id");    
    
       
    if($done){
    redirect(base_url('Welcome/tier'));
        }
