 ...
 $i++;
                                                    ...
                                                    <table class="table gridexample">
                                                        <tr>
                                                            ...
                                                            <td><input type="text" autofocus
                                                                    ...
                                                                    id="tehsilname" class="form-control"
                                                                    name="tehsilname" tabindex="1"></td>
                                                        </tr>
                                                        <tr>
	...
	if(isset($_POST['add'])){
		extract($_POST);
	$done=$this->db->query("select * from grm_tehsil_tbl where tehsil_name='$tehsilname'")->row();
	if($done){

	}else{
	$done=$this->db->query("insert into grm_tehsil_tbl set tehsil_name='$tehsilname'");	
	}
