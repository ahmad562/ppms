 ...
 $i++;
                                                    ...
                                                    <table class="table gridexample">
                                                        <tr>
                                                            ...
                                                            <td><input type="text" autofocus
                                                                    ...
                                                                    id="zone_name" class="form-control"
	...
	if(isset($_POST['add'])){
		extract($_POST);
	$done=$this->db->query("select * from grc_zone_tbl where zone_name='$zone_name'")->row();
	if($done){

	}else{
	$done=$this->db->query("insert into grc_zone_tbl set zone_name='$zone_name'");	
	}
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	if($done){
	redirect(base_url('Welcome/zone'));
		}
