...
?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <select class="form-control" name="saemr_id" id="saemr_id">
                                                            <option value="">Select Saemr</option>
 ...
 $i++;
	...
	if(isset($_POST['add'])){
		extract($_POST);
//$done=$this->db->query("select * from ppms_es_saemr_detail where es_seamr_name='$saemr_name'")->row();
//	if($done){

	//}else{
       
      $done=$this->db->query("insert into ppms_es_saemr_detail set es_seamr_id=$saemr_id,sps_id=$site_id,es_status=$status_id");	
	//}
