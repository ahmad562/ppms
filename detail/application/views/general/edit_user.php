                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>Edit User</h5>
                                <?php $done1=$this->db->query("select * from
                                             user_new as un,
                                            usr_group as ug,emp as e,city as c
                                            where un.group_id=ug.group_id
                                            and un.emp_id=e.emp_id
                            ...
                            <div class="card-block">
                                <div class="dt-responsive table-responsive">
                                <form method="post" action="<?php echo base_url('Emp/update_user')?>">               
...
<select name="emp_id" id="emp_id" class="form-control">
    <option value="<?php echo $done1->emp_id?>"><?php echo $done1->emp_name?></option>
<?php 
...
<?php }?>
            ...
            <div class="row form-group">
                ...
                <div class="col-sm-9">
                <input type="hidden" class="form-control" name="user_id" value="<?php echo $done1->user_id?>">
                    <input type="email" class="form-control" name="user_name" value="<?php echo $done1->user_name?>">
                </div>
            </div>
            <div class="row form-group">
                <div class="col-sm-3">
    ...
    <option value="<?php echo $done1->group_id?>"><?php echo $done1->group_name?></option>
<?php 
...
<?php }?>
    ...
    <option value="<?php echo $done1->city_id?>">
    <?php echo $done1->city_name;?>
</option>
<?php 
...
<?php }?>
            ...
            <div class="row form-group">
                ...
                <div class="col-sm-9">
                    <input type="password" class="form-control" name="passwords" value="">
                </div>
            </div>
