...
<?php }?>
                                    ...
                                    <?php $subProject=$this->db->query("select * from ppms_subproject where city_id=$cityID")->result();
                                                ...
                                                <td>Sub Sub Project</td>
                                                    <td>
                                                        <select name="sub_sub_project_id" id="sub_sub_project_id"
                                                            class="form-control" require  onChange="display_data(this.value)">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>File<br>
                                                    <font color="red">(Attached Multiple Files)</font></td>
                                                    <td><input type="file" placeholder="Attached Multiple Files"
                                                            required id="images" class="form-control" name="images[]"
                                                            tabindex="6" multiple></td>

                                                            <td>IPC No.</td>
                                                    <td><input type="text" placeholder="Enter IPC#" required
                                                            id="ipc_no" class="form-control"
                                                            name="ipc_no" tabindex="1"></td>
...
<tr><td>Contractor</td>
                                                    ...
                                                    <input type="text" placeholder="Enter IPA Amount" required
                                                            id="ipc_amount" class="form-control"
                                                            name="ipc_amount" tabindex="1">
                                                             </td></tr>
