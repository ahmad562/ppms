...
<?php $result = $this->db->query("SELECT * FROM ppms_service_type_tbl where std_id=$aid")->row(); ?>
                <!-- Main-body start -->
                <div class="main-body">
                                        ...
                                        <div class="card-block">
                                            <div class="dt-responsive table-responsive">
                                                <form role="form" method="post" id="create_item"
                                                    enctype="multipart/form-data" action="<?php echo base_url()?>complaint/update_std" autocomplete="off"
                                                    onsubmit="return confirm('Are you sure you want to submit this form?');">
<input type="hidden" autofocus  required id="" class="form-control"
    name="std_id" value="<?php echo $result->std_id; ?>" tabindex="1">
                                                    <table class="table gridexample">
                                                        <tr>
                                                            ...
                                                            <td><input type="text" autofocus
                                                                    ...
                                                                    name="std_name" value="<?php echo $result->std_name; ?>" tabindex="1"></td>
                                                        </tr>
                                                        <tr>
