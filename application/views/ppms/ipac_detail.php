                  ...
                  foreach($result1 as $item){
                   ...
                   ?>
                                    ...
                                    ?>
                                                        ...
                                                        <select name="designation" id="designation" style="width:80px;"
                                                            class="form-control"
                                                        ...
                                                        ?>
                                                            ...
                                                            <?php }else{?>
                                                            <option value="10">Director Technical</option>
                                                            <?php }?>
                                                                            ...
                                                                            <div class="card-block">
                                                                                <div class=""
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <!-- cd-timeline-block -->
                                                                                        <?php 
 $logee="SELECT d.designation_id,designation_name,forward_date,flag_id FROM ppms_forward_internal AS pfi,designation AS d
...
///////////////////////////////////////////////////////////
    ...
    $checkss=$this->db->query("SELECT organization_id 
