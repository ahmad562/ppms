...
if($groupID > 1){
   ...
   and a.es_seamr_id=b.es_seamr_id
                                ...
                                <div class="card-block">
                                    <div class="dt-responsive table-responsive">
                                        <form role="form" method="post" id="create_item" enctype="multipart/form-data"
                                            ...
                                            <input type="hidden" name="sdid" id="sdid" value="<?php echo $id;?>">
                                            <table class="table">
                                                <?php if($groupID == 1 or $groupID == 2 or $groupID == 5 or $groupID == 6){?>
                                                <tr>
                                                    <td>OutPut</td>
                                                    <td> <select class="form-control" name="output" id="output_id">
                                                            <option value="<?php echo $rows->output_id?>">
                                                                <?php echo $rows->output_name?></option>
                                                    ...
                                                    <td>
                                                        <select class="form-control" name="sectors" id="sectors_id">
                                                            <option value="<?php echo $rows->sector_id?>">
                                                                <?php echo $rows->sector_name?></option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="sub_project_id" id="sub_project_id"
                                                            class="form-control">
                                                            <option value="<?php echo $rows->subproject_id?>">
                                                                <?php echo $rows->subproject_name?></option>
                                                            <?php 
...
?>
                                                    ...
                                                    <td><select name="site_id" id="site_id" class="form-control">
                                                            ...
                                                            <option value="<?php echo $rows->sps_id?>">
                                                                <?php echo $rows->site_name?></option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Saemr Master</td>
                                                    <td> <select class="form-control" name="saemr_id" id="saemr_id">
                                                            <option value="<?php echo $rows->es_seamr_id?>">
                                                                <?php echo $rows->es_seamr_name?></option>
                                                            <?php $outList=$this->db->query("select * from ppms_es_saemer")->result();
                                                             foreach($outList as $outList){?>
                                                            <option value="<?php echo $outList->es_seamr_id?>">
                                                                <?php echo $outList->es_seamr_name?></option>
                                                            <?php }?>
                                                    ...
                                                    <td>Status</td>
                                                    <td> <select name="status_id" id="status_id" class="form-control"
                                                            required>
                                                            <option value="<?php echo $rows->es_status?>"><?php if($rows->es_status==1){
                                            echo "Approved";
               ...
               $i=1; 
                  ...
                  foreach($result1 as $item){?>
                                                <tr class="gradeX">
                                                    ...
                                                    <td align="center"><a
                                                            href="<?php echo base_url()?>Enviroment/edit_saemr_detail/<?php echo $item->es_sd_id;?>">
 ...
 $i++;
	...
	if(isset($_POST['add'])){
      ...
      $done=$this->db->query("update ppms_es_saemr_detail set es_seamr_id=$saemr_id,sps_id=$site_id,es_status=$status_id where es_sd_id=$sdid");	
	
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	if($done){
	redirect(base_url('Enviroment/saemr_detail'));
		}
