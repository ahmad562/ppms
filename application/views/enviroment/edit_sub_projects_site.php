        ...
        <div class="main-body">
            <div class="page-wrapper">
                ...
                <div class="page-body">
                    ...
                    <input type="hidden" name="site_id" class="form-control" value="<?php echo $id;?>"></td>
...
?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="project_id" id="projects" class="form-control">
                                                            ...
                                                            <option value="<?php echo $rows->project_id?>"><?php echo $rows->project_name;?></option>
                                                    ...
                                                    <td>
                                                        <select name="sub_project_id" id="sub_project_id"
                                                            ...
                                                            <option value="<?php echo $rows->subproject_id?>"><?php echo $rows->subproject_name?></option>
                                                ...
                                                <tr>
                                                    <td>Site Name</td>
                                                    <td><input type="text" name="site_name" class="form-control" value="<?php echo $rows->site_name?>"></td>
               ...
               $i=1; 
                  ...
                  foreach($result1 as $item){?>
                                                <tr class="gradeX">
                                                    ...
                                                    <td align="center"><a
                                                            href="<?php echo base_url()?>Welcome/edit_sub_projects_site/<?php echo $item->sps_id;?>">
 ...
 $i++;
	...
	$done=$this->db->query("update ppms_subproject_site set subproject_id=$sub_project_id,site_name='$site_name' where sps_id=$site_id");	
