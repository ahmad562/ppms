                                        ...
                                        <table class="table  table-bordered nowrap">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td align="center"> <a
                                                            href="<?php echo base_url('Welcome/mobilization_advance/')?><?php echo $id?>">
                                                    ...
                                                    <td align="center">
                                                        <a
                                                            href="<?php echo base_url('Welcome/bill_summary_detail_amount/')?><?php echo $id?>">
                                                    ...
                                                    <td align="center">
                                                        <a
                                                            href="<?php echo base_url('Welcome/boq_amount_percent/')?><?php echo $id?>">
                                                    ...
                                                    <td align="center">
                                                        <a href="<?php echo base_url('Welcome/payment_certificat/')?><?php echo $id?>"
                                                            target="parent">
...
?>
                                                            <tr>
                                                                <td style="width:40%"> (<?php echo $x; ?>)
                                                                    ...
                                                                    <select name="tax_id"
                                                                        onchange="update_record(<?php echo $row->ppms_payment_id;?>,1)"
                                                                        id="tax_id<?php echo $row->ppms_payment_id;?>"
                                                                        class="form-control"
                    ...
                    foreach($doneee111 as $doneee111){
                                    ?>
                                                                    ...
                                                                    <select name="add_less"
                                                                        onchange="update_record(<?php echo $row->ppms_payment_id;?>,1)"
                                                                        id="add_less<?php echo $row->ppms_payment_id;?>"
                                                                        class="form-control"
                                                                    ...
                                                                    <a href="javascript:"
                                                                        onClick="delete_record(<?php echo $row->ppms_payment_id;?>)">
                                                                ...
                                                                <td style="width:10%">
                                                                    <input type="text"
                                                                        id="tax<?php echo $row->ppms_payment_id;?>"
                                                         ...
                                                         //echo number_format($row->gross_payment,2);?>
                                                                    ...
                                                                    <input type="text"
                                                                        id="tax_amount<?php echo $row->ppms_payment_id;?>"
                                                                ...
                                                                <td align="left" style="width:40%">
                                                                    <textarea name="remarks"
                                                                        id="remarks<?php echo $row->ppms_payment_id;?>"
                                                                        onblur="update_record(<?php echo $row->ppms_payment_id;?>,1)"
...
<tr><td colspan="2"><b>Gross Amount</b></td>
