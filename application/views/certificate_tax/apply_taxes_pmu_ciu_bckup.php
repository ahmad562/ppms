...
<select name="add_less" onchange="update_record(<?php echo $row->ppms_payment_id;?>)" id="add_less<?php echo $row->ppms_payment_id;?>" class="form-control" style="width:100px;float:right;margin-top:-5px;margin-left:-100px">
...
<input type="text" id="tax<?php echo $row->ppms_payment_id;?>" name="tax" class="form-control" 
                                                            value="<?php echo $row->tax_value?>" onblur="update_record(<?php echo $row->ppms_payment_id;?>)">
...
<input type="text" id="tax_amount<?php echo $row->ppms_payment_id;?>" name="tax_amount"
                                                            ...
                                                            onblur="update_record(<?php echo $row->ppms_payment_id;?>)">
                                                    </td>
                                                    <td align="left" style="width:40%">
                <textarea name="remarks" id="remarks<?php echo $row->ppms_payment_id;?>" onblur="update_record(<?php echo $row->ppms_payment_id;?>)" 
...
<tr>
                                                    ...
                                                    <input type="text" id="tax" name="tax" class="form-control"
                                                            value="<?php echo $rowL->tax_value?>" onblur="get_tax_amount1()">
