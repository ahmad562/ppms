...
<script type="text/javascript">
 ...
 $.post("<?php echo base_url()?>Dropdowns/items_new_ipc/",{id:id,item_status:item_status,pid:pid},function(page_response){
...
alert(sub_project_idss);
                ...
                $.ajax({
                    url: '<?php echo base_url('Dropdowns/get_ipc_already')?>',  // PHP file to handle AJAX request
                    type: 'post',
                    data: {certificate_type: certificate_type,sub_project_idss:sub_project_idss},
                   // dataType: 'json',
                    success:function(html){
                        // Clear existing options
                        //alert(html);
                        $('#already_ipc').html(html);
                    }
                });
            });
 ...
 <script>
        //$(document).ready(function(){
            function get_already_ipc(certificate_type){
          //  $("#certificate_type").change(function(){
                //var certificate_type = $(this).val();
                var sub_project_idss = $('#sub_project_idss').val();
//alert(certificate_type);
