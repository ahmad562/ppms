    ...
    <div class="card-block">
        ...
        <div class="row">
          ...
          <div class="col-md-3">
              <button class="btn btn-success btn-block">
                  <i class="fas fa-edit"></i>
                        <a href="<?php echo base_url('Total_reports')?>">
                        <font color="white">
                       Enviromental Safeguard </font>
                      </a>
              </button>
          </div>
          <div class="col-md-3">
              <button class="btn btn-warning btn-block">
                  <i class="fas fa-table"></i><a href="<?php echo base_url('Total_reports/social')?>">
                  <font color="white"> Social Safeguard </font></a>
              </button>
          </div>
          <div class="col-md-3">
              <button class="btn btn-primary btn-block">
                  <i class="fas fa-plus-circle"></i><a href="<?php echo base_url('Total_reports/mande')?>"> 
                  <font color="white"> M & E  </font></a>
              </button>
          </div>
