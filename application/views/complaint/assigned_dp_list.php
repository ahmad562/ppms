                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <h4>Assigned Dp List</h4><?php $count=$this->db->query("select count(dp_detail_id) as dp from ppms_dp_detail")->row();
        ...
        <div class="col-6" >
            <div class="form-group">
               <label>City</label>
                                             <select name="city_id" id="city_id" class="form-control" onChange="assigned_city(this.value)">
        ...
        <div class="dt-responsive table-responsive" id="assigned_city">
    <table id="simpletable"
               ...
               $i=1; 
                  $result1 = $this->db->query("SELECT * FROM ppms_ss_db as psd,ss_dp_gender as sg,ppms_dp_detail as pdd,ppms_dp_status as pds,ppms_dp_city as pdc where pdd.dp_id=psd.ss_dp_id AND pdc.city_id=psd.city_id AND pds.ss_dp_status_id=pdd.status_id AND sg.gender_id=psd.ss_gender_id order by psd.ss_dp_id ASC")->result();
...
<script>
    ...
    function get_project(iddd_p,id_p){
            ...
            function insert_dp_detail(id){
             ...
             function assigned_city(city_id){
            $.ajax({
                url: "<?php echo base_url('Complaint/assigned_city') ?>",
                method: "POST",
                datatype: "html",
                data: {
                        city_id : city_id
