<?php $result2 = $this->db->query("SELECT * FROM grm_uc_tbl AS gut,grc_zone_tbl AS gzt Where gzt.zone_id=gut.zone_id AND gut.uc_id=$aid")->row(); ?>
 ...
 $i++;
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            <div class="dt-responsive table-responsive">
                                                <form role="form" method="post" id="create_item" enctype="multipart/form-data" action="<?php echo base_url()?>Complaint/update_uc" autocomplete="off"
...
<input type="hidden" name="uc_id" class="form-control" value="<?php echo $result2->uc_id ?>">
                                                    <table class="table gridexample">
                                                                    ...
                                                                    <td>UC</td>
                                                             <td>
                                       <input type="text" name="uc_name" class="form-control" value="<?php echo $result2->uc_name;?>">                          
                                                             </td>
                                                         </tr>
                                                          <tr>
                                                                    <td>Zone</td>
