        ...
        <div class="main-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" autofocus placeholder="Enter full Name"
                                                            required id="" class="form-control" name="full_name"
                                                            tabindex="1"></td>


                                                    <td>Employee No</td>
                                                    <td><input type="text" autofocus placeholder="Employee No" required
                                                            id="" class="form-control" name="emp_noy" tabindex="1"></td>
                                                </tr>
                                                <tr>
                                                    <td>Contract Award Date</td>
                                                    <td><input type="date" autofocus required id="" class="form-control"
                                                ...
                                                <tr>
                                                    <td>Contact No</td>
                                                    <td><input type="text" autofocus placeholder="Contact No" required
                                                            id="" class="form-control" name="contact_no" tabindex="1">
                                                    </td>
            ...
            ?>
                                                    ...
                                                    <td><input type="text" autofocus placeholder="CNIC" required id=""
                                                            class="form-control" name="cnic" tabindex="1"></td>
                                                </tr>
                                                <tr>
                                                    <td>Gender</td>
                                                    <td>
            ...
            ?>
                                                    ...
                                                    <td>Salary</td>
                                                    <td><input type="text" autofocus placeholder="Salary" required id=""
            ...
            ?>
                                                    ...
                                                    <td>
                                                        <select name="loan_grant" class="form-control">
                                                            <option value="">Select Loan/Grant</option>
                                            ...
                                            <tr>
                                              <td>Email</td>
                                                    <td><input type="text" autofocus placeholder="Email" required id=""
                                                            class="form-control" name="email" tabindex="1"></td>
                                              <td>Address</td>
                                              <td><textarea name="address" placeholder="Type address" class="form-control"></textarea></td>                
                                            </tr>
                                                <tr>
                                                ...
                                                <div class="col-sm-3">
                                                    Upload Picture
                                             <img id="blah" src="<?php echo base_url() ?>ass/assets/media/svg/files/blank-image.svg" width="225" height="225px" style="border: 1px solid black; margin-bottom: 1px;" class="rounded" />
                ...
                <i class="fas fa-plus"></i><a href="<?php echo base_url('Procurement/services_report')?>">
                <font color="white"> View Report</font></a>
                </button></h5>
                                    <span>
