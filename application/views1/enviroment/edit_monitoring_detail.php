            ...
            <div class="page-wrapper">
                ...
                <div class="page-header">
                    <div class="page-header-title">
                        <h4>Display External Monitoring Detail </h4>
                                ...
                                <div class="card-block">
                                    <div class="dt-responsive table-responsive">
                                        <form role="form" method="post" id="create_item" enctype="multipart/form-data"
                                            action="<?php echo base_url('Enviroment/edit_montiroing_detail')?>" autocomplete="off"
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <select class="form-control" name="output" id="output_id">
                                                            <option value="<?php echo $result1->output_id?>"><?php echo $result1->output_name?></option>
                                                    ...
                                                    <td>
                                                        <select class="form-control" name="sectors" id="sectors_id">
                                                            <option value="<?php echo $result1->sector_id?>"><?php echo $result1->sector_name?></option>
                                             ...
                                             <option value="<?php echo $result1->project_id?>"><?php echo $result1->project_name?></option>
...
?>
                                     ...
                                     <option value="<?php echo $result1->sps_id?>"><?php echo $result1->site_name?></option>
                                        ...
                                        <option value="<?php echo $result1->es_em_id?>">
                                        <?php echo $result1->es_em_name;?></option>
                                                            <?php $outList=$this->db->query("select * from ppms_es_externalmonitoring")->result();
                                                             foreach($outList as $outList){?>
                                                            <option value="<?php echo $outList->es_em_id?>">
                                                                <?php echo $outList->es_em_name?></option>
                                                            <?php }?>
                                                    ...
                                                    <td>
                                <input type="file" name="images[]" class="form-control" value="<?php echo $result1->es_file_attached?>">
                                                ...
                                                <tr>
                                                    <td>Date</td>
                                                    <td><input type="date" name="doc_date" class="form-control" value="<?php echo $result1->es_date?>"></td>


                                                    <td>Remarks</td>
                                                    <td colspan="3">
                                                        <textarea name="remarks" class="form-control">
                                                        <?php echo $result1->es_file_remarks?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="status_id" id="status_id" class="form-control"
                                                            required>
                                                            <option value="<?php echo $result1->es_emd_status;?>">
                                                            <?php if($result1->es_emd_status==0){
                                                        echo "Pending";
                                                    }else if($result1->es_emd_status==1){
                                                        echo "Approved";
                 ...
                 and a.es_em_id=a1.es_em_id
                  ...
                  foreach($result1 as $item){?>
                                                <tr class="gradeX">
                                                    ...
                                                    <td>
                            <a href="<?php echo base_url('img/enviroment/').$item->es_file_attached;?>">File Attached</a>
                                                    ...
                                                    <td align="center"><a
                                                            href="<?php echo base_url()?>Enviroment/edit_monitoring_detail/<?php echo $item->es_emd_id;?>">
