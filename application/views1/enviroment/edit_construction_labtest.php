                                ...
                                <div class="card-block">
                                    <div class="dt-responsive table-responsive">
                                        <form role="form" method="post" id="create_item" enctype="multipart/form-data"
                                            action="<?php echo base_url('Enviroment/edit_labtest')?>" autocomplete="off"
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <select class="form-control" name="output" id="output_id">
                                                            <option value="<?php echo  $res->output_id?>">
                                                                <?php echo  $res->output_name?></option>
                                                    ...
                                                    <td>
                                                        <select class="form-control" name="sectors" id="sectors_id">
                                                            <option value="<?php echo $res->sector_id?>">
                                                                <?php echo $res->sector_name?></option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="sub_project_id" id="sub_project_id"
                                                            class="form-control">
                                                            <option value="<?php echo $res->subproject_id?>">
                                                                <?php echo $res->subproject_name?></option>
                                                            <?php 
...
?>
                                                    ...
                                                    <td><select name="site_id" id="site_id" class="form-control">
                                                            ...
                                                            <option value="<?php echo $res->sps_id?>">
                                                                <?php echo $res->site_name?></option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Name</td>
                                                    <td>
                            <input type="hidden" name="site_idsss" class="form-control"
                                                            value="<?php echo $res->es_cit_id?>">


                                                        <input type="text" name="site_name" class="form-control"
                                                            value="<?php echo $res->es_cit_name?>">
                                                    </td>
                                                    ...
                                                    <td>
                                                        <input type="file" name="images[]" class="form-control" multiple
                                                            value="<?php echo $res->es_cit_document?>">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="date" name="doc_date" class="form-control"
                                                            value="<?php echo $res->es_cit_date?>">
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="status_id" id="status_id" class="form-control"
                                                            required>
                                                            <option value="<?php echo $res->es_cit_status?>">
                                                            <?php if($res->es_cit_status==1){
                                            echo "Approved";
               ...
               $i=1; 
                  ...
                  foreach($result1 as $item){?>
                                                <tr class="gradeX">
                                                   ...
                                                   <td> <a href="<?php echo base_url('img/lab/').$item->es_cit_document;?>">    
                                                   Attached Documents
                  </a></td>
                                                   
                                                    <td><?php echo $item->es_cit_remarks;?></td>

                                                    <td><?php if($item->es_cit_status==0){
                                                        echo "Pending";
                                                    }else if($item->es_cit_status==1){
                                                        echo "Approved";
