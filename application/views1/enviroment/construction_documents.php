                                ...
                                <div class="card-block">
                                    <div class="dt-responsive table-responsive">
                                        <form role="form" method="post" id="create_item" enctype="multipart/form-data"
                                            action="<?php echo base_url('Enviroment/add_construction')?>"
                                            autocomplete="off"
...
?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Title</td>
                                                    <td><input type="text" name="es_cd_title" class="form-control"></td>
         ...
         <a href="<?php echo base_url('img/upload_files/').$filesss->attached_file;?>" target="_new">(<?php echo $x;?>)File Attached<br></a>    
                                    <?php 
                                $x++;}?>                
                                                  </td>
                                                    ...
                                                    <td align="center"><a
                                                            href="<?php echo base_url()?>Enviroment/edit_construction_document/<?php echo $item->es_cd_id;?>">
