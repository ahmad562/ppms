<div class="pcoded-content">
   ...
   <td><a href="<?php echo base_url()?>Welcome/edit_source/<?php echo $item->source_id;?>">
...
<input type="hidden" placeholder="Enter source Name" required
        ...
        <table class="table gridexample">
          <tr>
            <td>source</td>
            <td>
        <input type="text" autofocus value="<?php echo $result1->source_name;?>" placeholder="Enter source Name" required id="source" class="form-control txt" name="source" tabindex="1"></td>
             </tr>
          <tr>
...
$done=$this->db->query("update source set source_name='$source' 
where source_id=$source_id");    
    
       
    if($done){
    redirect(base_url('Welcome/display_source'));
        }
