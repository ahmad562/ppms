    ...
    <div class="pcoded-inner-content">
        <div class="main-body">
            <div class="page-wrapper">
                ...
                $icrm_data=$this->db->query("select * from hr_icrm as hi,hr_individual_package as hip
                 where hi.icrm_id=$icrms_id and hi.hr_in_package_id=hip.hr_in_package_id")->row_array();
                
                ?>
<div class="container">
   
    <form action="<?php echo base_url('Hr_qcbs/edit_icrms_record/'.$icrm_data['icrm_id']); ?>" method="post">
            ...
            <table class="table">
                ...
                <option value="planned" <?php echo ($icrm_data['planned_approved']=== 'planned') ? 'selected' : ''; ?>>
                    Planned
                </option>
                <option value="actual" <?php echo ($icrm_data['planned_approved'] === 'actual') ? 'selected' : ''; ?>>
                    Actual
                </option>
            </select>
                            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                ...
                                <input type="date" id="intendedcompletion" name="intendedcompletion" required class="form-control" value="<?php echo isset($icrm_data['intended_completion']) ? $icrm_data['intended_completion'] : ''; ?>">
                            </div>
                        </td>
                    ...
                    <td>
                            <div class="form-group">
                                ...
                                <input type="text" id="AwardedAmount" name="AwardedAmount" required class="form-control" value="<?php echo isset($icrm_data['awarded_amount']) ? $icrm_data['awarded_amount'] : ''; ?>">
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
        ...
        <?php /*?><div class="form-group">
            <label for="planned_approved">Planned Approved:</label>
            <select id="planned_approved" name="planned_approved" class="form-control" required>
                <option value="planned" <?php echo ($icrm->planned_approved === 'planned') ? 'selected' : ''; ?>>
                    Planned
                </option>
                <option value="actual" <?php echo ($icrm->planned_approved === 'actual') ? 'selected' : ''; ?>>
                    Actual
                </option>
            </select>
        </div>
        <div class="form-group">
            ...
            <input type="date" id="sub_adb" name="sub_adb" value="<?php echo $icrm->sub_adb; ?>" class="form-control"
                required>
        </div>
        <div class="form-group">
            <label for="adb_approval">ADB Approval:</label>
            <input type="date" id="adb_approval" name="adb_approval" value="<?php echo $icrm->adb_approval; ?>"
                class="form-control" required>
        </div>
        <div class="form-group">
            <label for="eoi_advert">EOI Advertisement:</label>
            <input type="date" id="eoi_advert" name="eoi_advert" value="<?php echo $icrm->eoi_advert; ?>"
                class="form-control" required>
        </div>
        <div class="form-group">
            <label for="hr_in_package_id">Package:</label>
            <select id="hr_in_package_id" name="hr_in_package_id" class="form-control" required>
                ...
                <option value="<?php echo $package->hr_in_package_id; ?>" <?php echo ($package->hr_in_package_id === $icrm->hr_in_package_id) ? 'selected' : ''; ?>>
        ...
        <div class="form-group">
            <label for="budget_adb">Budget ADB:</label>
            <input type="number" id="budget_adb" name="budget_adb" value="<?php echo $icrm->budget_adb; ?>"
                class="form-control" required>
        </div>
        <div class="form-group">
            <label for="adb_clear">ADB Clear:</label>
            <input type="date" id="adb_clear" name="adb_clear" value="<?php echo $icrm->adb_clear; ?>"
                class="form-control" required>
        </div>
        <button type="submit" name="submit" class="btn btn-primary mt-3">Update ICRM Data</button>
    </form>
    <?php */?>
</div>
