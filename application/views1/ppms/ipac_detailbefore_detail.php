...
echo $remarkss->ipac_remark;?>
                ...
                ?>
                                                        <label class="label label-success">Farwarded</label><br>
                                                        <span align="center" style="font-weight:700;">
                ...
                ?>
                                                        ...
                                                        <label class="label label-danger">Approved</label><br>
                                                        <span align="center" style="font-weight:700;">
                                                            <a href="" data-toggle="modal"
                                                                data-target="#Modal-tab<?php echo $item->ipac_id?>">
                                                                <?php echo $tracs->organization_name;?></a></span>
                                                   ...
                                                   if($orgName->organization_id==$tracs->organization_id){
                                                    if($orgName->organization_id==4){?>
                                                        ...
                                                        if($tracs->status_id==3){
                                                            echo "<label class='label label-success'>Forwarded</button>";
                                    }else if($tracs->status_id==4 or $tracs->status_id==5){
                                        echo "<label class='label label-primary'>Approved</button>";                
                                                        
                                                    }else{?>
                                                        <a href="javascript:">
                                                            <button class="btn btn-danger"
                                                                onClick="forward(<?php echo $item->ipac_id?>,<?php echo $orgName->organization_id;?>)">Click
                                                                to Forward</button></a>
                                                        <?php }?>
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <a href="#">
                                                                                                          ...
                                                                                                          echo "<label class='label label-success'>Recieved</label>";
                                                                                                            ...
                                                                                                            echo "<label class='label label-danger'>Forwarded</label>";
                                                                                                            ...
                                                                                                            echo "<label class='label label-danger'>Approved</label>";
                                                                                                        }?>
