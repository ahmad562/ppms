               ...
               $i=1; 
                  ...
                  foreach($result1 as $item){?>
                                                <tr class="gradeX">
                                                    ...
                                                    <td><?php echo $item->output_amount;?></td>
                                ...
                                <div class="card-block">
                                    <div class="dt-responsive table-responsive">
                                        <form role="form" method="post" id="create_item" enctype="multipart/form-data"
                                           ...
                                           <?php
                                            $edit = $this->db->query("SELECT * FROM ppms_output_list where output_id=$id")->row();
                                           ?>
 <input type="hidden"  required
                                        id="output_id" class="form-control" name="output_id"
                                        value="<?php echo $edit->output_id;?>">
                                            <table class="table">
                                                <tr>
                                                    <td>Name</td>
                                                    <td><input type="text" autofocus placeholder="Enter OutPut Name"
                                                            required id="output_name" class="form-control" name="output_name"
                                                            tabindex="1" value="<?php echo $edit->output_name;?>"></td>
                                                </tr>
                                                <tr>
                                                    <td>Percentage</td>
                                                    <td><input type="text" autofocus placeholder="Enter OutPut(%)"
                                                            required id="percentage" class="form-control" name="percentage"
                                                            tabindex="2" value="<?php echo $edit->output_percentage;?>"></td>
                                                </tr>
                                                <tr>
                                                    <td>Amount</td>
                                                    <td><input type="text" autofocus placeholder="Enter OutPut Amount"
                                                            ...
                                                            tabindex="3" value="<?php echo $edit->output_amount;?>"></td>
                                                </tr>
	...
	if(isset($_POST['add'])){
		extract($_POST);
	$done=$this->db->query("select * from ppms_output_list where output_id=$output_id")->row();
	if($done){
$done=$this->db->query("update ppms_output_list set output_name='$output_name',output_percentage='$percentage',output_amount='$output_amount' where output_id=$output_id");	
	}
