...
ppms_ipac_file where ipac_id=$ipc_iddd and ipac_user_id=$remarkss->emp_id and ipac_remarks_id=$remarkss->ipac_remarks_id";
 ...
 ?>
                    ...
                    <td><input type="checkbox" value="1" onchange="enable_inputs(this,<?php echo $ipc_iddd;?>,<?php echo $subID;?>,<?php echo $subsubID;?>)" id="enable_summary" class="form-control"></td></tr>
                                                        </table>
                                                        <?php 
...
<script>
    function enable_inputs(checkbox,ipc,subID,subsubID){
