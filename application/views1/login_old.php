    ...
    <section class="login p-fixed d-flex text-center">
        ...
        <div class="container-fluid">
            <div class="row">
                        ...
                        <form class="md-float-material" method="post" action="<?php echo base_url()?>Users/checkUsers">
                            ...
                            <div class="auth-box">
                                ...
                                <div class="input-group">
                                    <input type="email" class="form-control" placeholder="Your Email Address" id="username" name="username" required>
                ...
                <img src="<?php echo base_url('img/logo.png')?>" width="450px" height="500px">
