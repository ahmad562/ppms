    ...
    <div class="pcoded-inner-content">
        ...
        <div class="main-body">
            <div class="page-wrapper">
               ...
               $i=1; 
                  $result1 = $this->db->query("SELECT * FROM total_reports where flag_id=3")->result();
                  foreach($result1 as $item){?>
                                                 <tr class="gradeX">
                                                    ...
                                                    <td align="center"><a
                                                            href="<?php echo base_url()?>Total_reports/edit_mande/<?php echo $item->report_id;?>">
                                    ...
                                    <div class="dt-responsive table-responsive">
                                        <form role="form" method="post" id="create_item" enctype="multipart/form-data"
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td>Period Detail</td>
                                                    <td><input type="text" placeholder="Enter Period Name" required
                                                            id="period" class="form-control" name="period" tabindex="2">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>File</td>
                                                    <td><input type="file" placeholder="Enter File Name" 
                                                            id="Pict_upload" class="form-control" name="Pict_upload"
                                                            tabindex="3"></td>
                                                </tr>
                                                <input type="hidden" placeholder="Enter File Name" required value="3"
