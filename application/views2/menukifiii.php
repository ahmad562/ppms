...
<div class="pcoded-navigatio-lavel" data-i18n="nav.category.ui-element" menu-title-theme="theme5"><?php echo $moduule->module_name;?></div>
                            ...
                            foreach($parent as $parent){?>
                                <li class="pcoded-hasmenu">
                                    ...
                                    echo base_url().$parent->menu_url;
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main"><?php echo $parent->menu_name;?></span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
