...
$z++;
                                                                                ...
                                                                                <tbody>
                                                                                    <?php
                                        error_reporting(0);
                                        $xyz="SELECT * FROM ppms_billsummary as a,ppms_billsummary_category as b
                                        ...
                                        $result1 = $this->db->query($xyz)->result();
                                        $j=1;
                                        $d1=0;
                                        foreach($result1 as $item){?>
                                                                                    <tr>
                                        ...
                                        ?>
                                                            ...
                                                            WHERE `subproject_id`=$subID AND `sub_sub_project_id`=$main->sub_sub_project_id AND billsummary_id=$item->billsummary_id
                                                                                        ...
                                                                                        <?php 
                                                                                        $doneeee="select * from ppms_ipc_billsummary where
