    ...
    ?> </td>
               ...
               $i=1; 
                  ...
                  foreach($result1 as $items){?>
                    ...
                    <td  width="60%">
                       <?php if($groupID==1){?> 
    <input type="text" name="item_id" class="form-control" value="<?php echo $items->item_name;?>" onBlur="edit_itemName(this.value,<?php echo $items->item_id;?>)">
                    <?php
                       }else{?>
...
?>
 ...
 <input type="checkbox" id="item_ids<?php echo $items->item_id;?>" onClick="get_checkbox(<?php echo $items->item_id;?>,<?php echo $id?>)" name="item_id[]" value="<?php echo $items->item_id;?>" <?php echo $checked;?> class="form-control">
</td>
<?php if($groupID==1){?>
                                                                ...
                                                                <td>
<a href="javascript:" onClick="delete_item(<?php echo $items->item_id;?>)">
