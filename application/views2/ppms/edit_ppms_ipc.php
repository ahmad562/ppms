...
<a href="javascript:" onClick="delete_files(<?php echo $filess->ipac_file_id?>)">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="file" placeholder="Please Attached a File" required
            ...
            ?>  
                ...
                <?php echo $abc_remarkss1->ipac_remark?>
                                                ...
                                                <tr>
                                                   ...
                                                   WHERE ps.contractor_id=ar.emp_id AND ps.subproject_id=$done->project_area_id";
            ...
            ?>
             <select name="contractor_id" id="contractor_id" class="form-control">
               ...
               <?php }?>
                                                ...
                                                <td><b>
                    <font color="red">IPA Contractor Amount(In PKR) Million
                    </b></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" placeholder="Enter IPC#" required id="ipc_no"
                                                            ...
                                                            <td><b>
                    <font color="red">IPC Verified Amount(in PKR) Million</font>
                </b>
                                                             </td>
                                                             <td>
...
<?php */?>
                    ...
                    function delete_files(id) {
                        ...
                        $.post("<?php echo base_url()?>Welcome/delete_file_ppms_edit/", {
                           
                            id: id
                    
                        }, function(page_response) {
                            ///alert(page_response);
                            ///$("#forward_data").html(page_response);
                            if(page_response==1){
                                location.reload(); 
                            }else if(page_response==0){
                                alert("Some Problem Not Deleted");
                            }
