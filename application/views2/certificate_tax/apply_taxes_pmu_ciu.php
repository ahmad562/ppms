            ...
            <div class="page-wrapper">
                ...
                <div class="page-header">
                    ...
                    <div class="col-sm-12">
                        ...
                        <button class="btn btn-warning btn-round"><a href="<?php echo base_url('Certificate_tax')?>">
                                <font color="white">View Taxes</font>
                            </a></button>

                        <button class="btn btn-success btn-round"><a href="<?php echo base_url('Certificate_tax/tax_detail')?>">
                        ...
                        <button class="btn btn-danger btn-round"><a
