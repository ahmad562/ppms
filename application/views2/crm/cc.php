        ...
        <td><a href="<?php echo base_url()?>Welcome/edit_cc/<?php echo $item->cc_id;?>">
 ...
 $i++;
	...
	if(isset($_POST['add'])){
		extract($_POST);
	$done=$this->db->query("select * from grm_complaint_category where cc_name='$ccname'")->row();
	if($done){

	}else{
	$done=$this->db->query("insert into grm_complaint_category set cc_name='$ccname'");	
	}
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	if($done){
	redirect(base_url('Welcome/display_cc'));
		}
