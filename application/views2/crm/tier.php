               ...
               $i=1; 
                  ...
                  foreach($result1 as $item){?>
                                                        <tr class="gradeX">
                                                            ...
                                                            <td><a
                                                                    href="<?php echo base_url()?>Welcome/edit_tier/<?php echo $item->tier_id;?>">
 ...
 $i++;
                        ...
                        id="tier" class="form-control"
                        name="tierdays" tabindex="1"style=></td>
                             </tr>
                                                        <tr>
	...
	if(isset($_POST['add'])){
		extract($_POST);
	$done=$this->db->query("select * from grm_tier_tbl where tier_name='$tiername'and tier_days=$tierdays")->row();
	if($done){
