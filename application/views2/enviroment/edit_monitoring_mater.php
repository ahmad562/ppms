...
<?php
                  ...
                  $row1 = $this->db->query("
                  SELECT * FROM ppms_es_externalmonitoring where es_em_id=$id
...
<div class="pcoded-content">
                                        ...
                                        <form role="form" method="post" id="create_item" enctype="multipart/form-data"
                                            ...
                                            <table class="table">
                                                ...
                                                <input type="hidden" name="mid" class="form-control"
                                                    value="<?php echo $row1->es_em_id?>">
                                                <td><input type="text" name="es_em_name" class="form-control"
                                                        value="<?php echo $row1->es_em_name?>">
                                                </td>
 ...
 $i++;
	...
	if(isset($_POST['add'])){
      ...
      $done=$this->db->query("update ppms_es_externalmonitoring set es_em_name='$es_em_name' where es_em_id=$mid");	
