...
if($groupID > 1){
   ...
   $row1 = $this->db->query("
   SELECT * FROM 
   ppms_es_saemer where es_seamr_id=$id")->row();
?>
...
?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Saemr Name</td>
                                                    <td>
                    <input type="hidden" name="saemr_id" class="form-control" value="<?php echo $id?>">

                            <input type="text" name="saemr_name" class="form-control" value="<?php echo $row1->es_seamr_name?>"></td>
 ...
 $i++;
	...
	if(isset($_POST['add'])){
      ...
      $done=$this->db->query("update ppms_es_saemer set es_seamr_name='$saemr_name' where es_seamr_id=$saemr_id");	
