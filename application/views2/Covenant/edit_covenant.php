...
<?php 
                ...
                WHERE sd.`covenant_id`=cn.`covenant_name_id` and covenant_detail_id=$cid")->row();
                ?>
<form method="post" action="<?php echo base_url('Covenant/update_record_detail');?>">
    <div class="container">
        <div class="row">
        <div class="col-6">
            <label for="covenant_detail">SerialNo:</label>
            <input type="text" class="form-control" name="serialNo" value="<?php echo $covenant_details->serial_no?>">
            </div>
            <div class="col-6">
<input type="hidden" class="form-control" name="cid" value="<?php echo $covenant_details->covenant_detail_id?>">
            ...
            <div class="form-group ">
                ...
                <option value="<?php echo $covenant_details->covenant_name_id?>">
<?php echo $covenant_details->covenant_name?>
...
<?php }?>
            ...
            <div class="form-group">
                ...
                <option value="<?php echo $covenant_details->category_name?>">
<?php echo $covenant_details->category_name?>
...
Governance and Anticorruption
     ...
     <input type="text" class="form-control" name="reference" value="<?php echo $covenant_details->reference?>">
            </div>
            </div>
            <div class="col-6">
            <div class="form-group">
                ...
                <option value="<?php echo $covenant_details->status_id?>">
                <?php echo $covenant_details->status_id?>
</option>  
...
Not due yet
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="covenant_detail"><?php echo $covenant_details->covenant_detail?></textarea>
            </div>
            </div>
            <div class="col-12">
            <div class="form-group">
                <label for="covenant_detail">Remarks:</label>
                <textarea class="form-control" name="remarks"><?php echo $covenant_details->remarks?></textarea>
            </div>
            </div>
          
            <div class="col-6">
            <button type="submit" class="btn btn-primary">Edit Covenant Detail</button>
            </div>
        </form>
