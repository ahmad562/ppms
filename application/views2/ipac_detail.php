...
echo "<label class='label label-success'>".$woweekends." Days Remaining</label>";
              ...
              echo "<label class='label label-primary'>Approved</label>";                
                                                        ...
                                                        <a href="javascript:"
                                                            ...
                                                            <img src="<?php echo base_url('img/click_here.GIF')?>"
            ...
            if($kifi->status_id==1){
                echo "<font color='white'>Paid</font>";
            }else{
echo "<font color='white'>Un Paid</font>";
 ...
 ?>
                                                                    ...
                                                                    <div class="tab-pane"
                                                                        ...
                                                                        <strong style="color:red;">Total Days:
                                                                            <?php 
                                                                        echo 35;
                                                                        
                                                                        ?></strong>

                                                                        <strong style="color:green;">Total Day's Spent:
                                                <?php
                                                ...
                                                ?>
                                                                        ...
                                                                        <strong style="color:red;">Total Day's Remaining:
                                                                            <?php 
                                                                        echo 35 - $woweekends;
